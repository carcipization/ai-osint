...
- [Respiratory Virus Response (RVR) U.S. Hospitalization Metrics by Jurisdiction (Timeseries)](https://catalog.data.gov/dataset/respiratory-virus-response-rvr-united-states-hospitalization-metrics-by-jurisdiction-times) — CDC/NHSN-derived jurisdiction timeseries on admissions and inpatient/ICU occupancy for monitoring healthcare-system stress during respiratory waves. High-value operational burden signal with reporting-lag and definition-change caveats.
