...
- **Primary URL:** [https://opensky-network.org/data](https://opensky-network.org/data)
...
- **Primary URL:** [https://www.adsbexchange.com/data/](https://www.adsbexchange.com/data/)
...
- **Primary URL:** [https://www.adsb.lol/docs/open-data/api/](https://www.adsb.lol/docs/open-data/api/)
...
- **Primary URL:** [https://marinecadastre.gov/accessais/](https://marinecadastre.gov/accessais/)
...
### AISHub API
- **Primary URL:** [https://www.aishub.net/api](https://www.aishub.net/api)
...
### OpenCorporates API
- **Primary URL:** [https://api.opencorporates.com/](https://api.opencorporates.com/)
...
- **Primary URL:** [https://register.openownership.org/](https://register.openownership.org/)
...
- **Primary URL:** [https://download.companieshouse.gov.uk/en_pscdata.html](https://download.companieshouse.gov.uk/en_pscdata.html)
...
### USAspending API
- **Primary URL:** [https://api.usaspending.gov/](https://api.usaspending.gov/)
...
- **Primary URL:** [https://data.ted.europa.eu/](https://data.ted.europa.eu/)  
- **API docs:** [https://docs.ted.europa.eu/api/latest/index.html](https://docs.ted.europa.eu/api/latest/index.html)
...
- **Primary URL:** [https://www.contractsfinder.service.gov.uk/apidocumentation](https://www.contractsfinder.service.gov.uk/apidocumentation)
...
- **Primary URL:** [https://tgstat.com/api/stat](https://tgstat.com/api/stat)
...
### Telemetr public API
- **Primary URL:** [https://api.telemetr.io/](https://api.telemetr.io/)
...
- **Primary URL:** [https://github.com/SystemsLab-Sapienza/TGDataset](https://github.com/SystemsLab-Sapienza/TGDataset)
